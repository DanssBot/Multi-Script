#!/bin/bash
 ...
 post_reboot(){
   echo 'wget -O /root/install.sh "https://raw.githubusercontent.com/DanssBot/Multi-Script/main/R9/install-Of.sh"; clear; sleep 2; chmod +x /root/install.sh; /root/install.sh --continue' >> /root/.bashrc
